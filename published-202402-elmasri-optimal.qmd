...
Markdown(tabulate(
  table, 
  headers=["", r"${\boldsymbol\Sigma}^*$", r"$\widehat{{\boldsymbol\Sigma}}^*$", r"$\widehat{{\boldsymbol\Sigma}}_{opt}$",
           r"$\widehat{{\boldsymbol\Sigma}}_{mean}$", r"${\widehat{{\boldsymbol\Sigma}}^{+d}_{opt}}$",
           r"$\widehat{{\boldsymbol\Sigma}}^{+d}_{mean}$", "vMFN"],
    tablefmt="pipe"))
```
...
Markdown(tabulate(
  table, 
  headers=["", r"${\boldsymbol\Sigma}^*$", r"$\widehat{{\boldsymbol\Sigma}}^*$",
	   r"$\widehat{{\boldsymbol\Sigma}}_{opt}$",
           r"$\widehat{{\boldsymbol\Sigma}}_{mean}$", r"${\widehat{{\boldsymbol\Sigma}}^{+d}_{opt}}$",
           r"$\widehat{{\boldsymbol\Sigma}}^{+d}_{mean}$", "vMFN"],
    tablefmt="pipe"))
```
